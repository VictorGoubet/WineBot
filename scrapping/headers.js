...
const optionsReviews = (id) =>{ return {
    ...
    'url':`https://www.vivino.com/api/wines/${id}/reviews?per_page=10&page=1`
}
}


module.exports = {optionsInfo, optionsReviews};